...
function createZeroPepe(): void {
    ...
    pepe.named = false;
    pepe.name = "Pepe #0";
    pepe.mintedAt =  dataSource.network() == "goerli"?  BigInt.fromI32(8894602) : BigInt.fromI32(6481925);
    pepe.blockNumber = dataSource.network() == "goerli"?  BigInt.fromI32(8894602) : BigInt.fromI32(6481925);
    pepe.save();
}

export function createPepe(tokenID: BigInt, motherID: BigInt, fatherID: BigInt, ownerID: string, blockNumber: BigInt, timestamp: BigInt ): Pepe {
...
export function createPepeNamed(txHash: Bytes, tokenID: BigInt, receiverID: string, blockNumber: BigInt, name:string,  timestamp: BigInt) : void {
